...
function loadCharts() {
  (e = getChartColorsArray("basic_polar_area")) &&
    ((r = {
      ...
      responsive: [
        {
          breakpoint: 480,
          options: { chart: { width: 250 }, legend: { show: !1 } },
        },
      ],
    }),
    "" != chartPolarareaBasicChart && chartPolarareaBasicChart.destroy(),
    (chartPolarareaBasicChart = new ApexCharts(
