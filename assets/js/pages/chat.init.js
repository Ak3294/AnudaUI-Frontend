...
function increment() {
  1 == running &&
    setTimeout(function () {
      ...
      s <= 9 && (s = "0" + s),
        (document.getElementById("outputt").innerHTML = e + ":" + t + ":" + s),
        increment();
    }, 100);
}
!(function () {
  ...
  function p(e, t, s, n, c) {
    ...
    if (null != t)
      ...
      for (a += '<div class="message-img mb-0">', i = 0; i < s.length; i++)
        a +=
              ...
              0 < a
                ...
                : ((n = t.from_id == m ? " right" : " left"),
                  ...
                  (n =
                    ...
                    p(t.id, t.msg, t.has_images, t.has_files, t.has_dropDown)),
                  c[e + 1] &&
          ...
          (document.querySelector(
            ...
            document.getElementById(e).querySelector(".userprofile")
              ? ((t = document
                  ...
                  .getAttribute("src")),
                document
                  .querySelector("#users-chat .user-chat-topbar .avatar-xs")
                  .setAttribute("src", t),
                document
            ...
            (document.querySelector(
              ...
              n
                ...
                ? ((t = n
                    ...
                    .getAttribute("src")),
                  document
                    .querySelector("#users-chat .user-own-img .avatar-xs")
                    .setAttribute("src", t),
                  document
  ...
  function w() {
    x.querySelectorAll(".chat-conversation-list .chat-list").forEach(function (
      e
    ) {
          ...
          c.addEventListener("click", function () {
            var e = document.querySelector(".replyCard"),
              ...
              t =
                ...
                !c.closest(".chat-list") ||
                c.closest(".chat-list").classList.contains("left")
                  ? n
                  : "You");
            (document.querySelector(
              ".replyCard .replymessage-block .flex-grow-1 .conversation-name"
...
var Dtime = 0,
  running = !1,
  scrollEl =
    (Array.from(document.querySelectorAll(".video-icon")).forEach(function (e) {
      e.addEventListener("click", function () {
        document
    ...
    Array.from(document.querySelectorAll(".call-disconnect")).forEach(function (
      e
    ) {
      e.addEventListener("click", function () {
        document
