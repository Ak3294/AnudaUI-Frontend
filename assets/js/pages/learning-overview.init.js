document.getElementById("agent-chat").addEventListener("click", function () {
  document.getElementById("emailchat-detailElem").classList.contains("d-block")
    ? document
    ...
    return (
      ...
      !editList
        ...
        : "" !== reviewTitleInput.value &&
          ...
          (document.getElementById(i).querySelector(".rate-num").innerHTML =
            parseFloat(e).toFixed(1)),
          (document.getElementById(i).querySelector(".review-title").innerHTML =
            reviewTitleInput.value),
          (document.getElementById(i).querySelector(".review-desc").innerHTML =
            reviewDescInput.value),
          (document
            .getElementById(i)
      ...
      r.querySelector(".edit-item-list").addEventListener(
        ...
        function (e) {
          ...
          (document.getElementById("id-field").value = t),
            ...
            (reviewDescInput.value = r.querySelector(".review-desc").innerHTML),
            r.querySelectorAll(".review-gallery-img .product-img") &&
              r
                .querySelectorAll(".review-gallery-img .product-img")
                .forEach(function (e) {
                  var t = { name: e.getAttribute("alt"), size: 12345 };
                  dropzone.options.addedfile.call(dropzone, t),
                    dropzone.options.thumbnail.call(dropzone, t, e.src);
                }),
