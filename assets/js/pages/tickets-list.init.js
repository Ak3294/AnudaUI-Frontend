...
function handleClickPrev() {
  ...
  listjsPagination &&
    listjsPagination.querySelector(".active") &&
    (e = listjsPagination.querySelector(".active")).previousElementSibling &&
    ...
    return (
      ...
      !editList && a
        ...
        : editList &&
          ...
          Array.from(e).forEach(function (e) {
            new DOMParser().parseFromString(e._values.tickets_id, "text/html")
    ...
    Array.from(editBtns).forEach(function (e) {
      e.addEventListener("click", function (e) {
        ...
        Array.from(e).forEach(function (e) {
          ...
          t == a &&
            ((editList = !0),
            (document.getElementById("addTicketModalLabel").innerHTML =
              "Edit Ticket Details"),
            ...
            Array.from(
              document.querySelectorAll(".select-element .option-list")
            ).forEach(function (a) {
              var i = a.querySelector(".flex-grow-1 .d-block").innerHTML;
              new DOMParser()
                ...
                .forEach(function (e) {
                  ...
                  return (
                    e.getAttribute("data-bs-title") == i &&
                      ...
                      (a.querySelector(".btn-action").innerHTML = "Remove"),
                      tooltipElm()),
                    a
                  );
                });
            ...
            (priorityInput.value = t.body.querySelector(".badge").innerHTML),
            ...
            (statusInput.value = t.body.querySelector(".badge").innerHTML),
            ...
            e.body.firstElementChild.innerHTML == itemId &&
              document
                ...
                .addEventListener("click", function () {
                  ticketsList.remove("tickets_id", t.outerHTML),
...
function clearFields() {
  (editList = !1),
    ...
    flatpickr("#create-date-input", { dateFormat: "d M, Y" }),
    flatpickr("#due-date-input", { dateFormat: "d M, Y" }),
    Array.from(document.querySelectorAll(".option-list")).forEach(function (e) {
...
function deleteMultiple() {
  ...
  for (i = 0; i < a.length; i++)
    1 == a[i].checked &&
      ((e =
        a[i].parentNode.parentNode.parentNode.querySelector("td a").innerHTML),
      t.push(e));
  void 0 !== t && 0 < t.length
    ? Swal.fire({
        title: "Are you sure?",
      ...
      t.classList.toggle("active"),
        t.classList.contains("active")
          ? ((e = t.querySelector(".flex-grow-1 .d-block").innerHTML),
            ...
            (a.innerHTML = "Remove"),
            tooltipElm())
          : Array.from(n.querySelectorAll(".avatar-group-item")).forEach(
              function (e) {
