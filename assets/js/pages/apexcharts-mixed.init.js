...
function loadCharts() {
  var e, t;
  (t = getChartColorsArray("line_column_chart")) &&
    ((e = {
      series: [
        {
          name: "Website Blog",
    ...
    "" != chartLineColumnChart && chartLineColumnChart.destroy(),
    (chartLineColumnChart = new ApexCharts(
      document.querySelector("#line_column_chart"),
      e
    )).render()),
    (t = getChartColorsArray("multi_chart")) &&
      ((e = {
        series: [
          {
            name: "Income",
      ...
      "" != chartMultiChart && chartMultiChart.destroy(),
      (chartMultiChart = new ApexCharts(
        document.querySelector("#multi_chart"),
        e
      )).render()),
    (t = getChartColorsArray("line_area_chart")) &&
      ((e = {
        series: [
          {
            name: "TEAM A",
      ...
      "" != chartLineAreaChart && chartLineAreaChart.destroy(),
      (chartLineAreaChart = new ApexCharts(
        document.querySelector("#line_area_chart"),
        e
      )).render());
  (t = getChartColorsArray("line_area_charts")) &&
    ((e = {
      series: [
        {
          name: "TEAM A",
