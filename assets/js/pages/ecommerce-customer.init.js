var ckClassicEditor = document.querySelectorAll(".private-notes"),
  ...
  customerList = new List("customer-list", options).on("updated", function (e) {
        ...
        e.addEventListener("click", function (e) {
          ...
          Array.from(e).forEach(function (e) {
            ...
            t == itemId &&
              ...
              (statsField.value = t.body.querySelector(".badge").innerHTML),
        ...
        e.addEventListener("click", function (e) {
          ...
          Array.from(e).forEach(function (e) {
            ...
            (isid = new DOMParser().parseFromString(e._values.id, "text/html"))
              ...
              (document.querySelector("#overview-card .overview-img").src =
                t.body.querySelector(".customer-image-elem").src),
