...
function loadCharts() {
  var e, t;
  (t = getChartColorsArray("basic_timeline")) &&
    ((e = {
      series: [
        {
          data: [
    ...
    "" != chartTimelineBasicChart && chartTimelineBasicChart.destroy(),
    (chartTimelineBasicChart = new ApexCharts(
      document.querySelector("#basic_timeline"),
      e
    )).render()),
    (t = getChartColorsArray("color_timeline")) &&
      ((e = {
        series: [
          {
            data: [
      ...
      "" != chartTimelineChart && chartTimelineChart.destroy(),
      (chartTimelineChart = new ApexCharts(
        document.querySelector("#color_timeline"),
        e
      )).render()),
    (t = getChartColorsArray("multi_series")) &&
      ((e = {
        series: [
          {
            name: "Bob",
      ...
      (chartTimelineMultiSeriesChart = new ApexCharts(
        document.querySelector("#multi_series"),
        e
      )).render()),
    (t = getChartColorsArray("advanced_timeline")) &&
      ((e = {
        series: [
          {
            name: "Bob",
      ...
      "" != chartTimelineAdvancedChart && chartTimelineAdvancedChart.destroy(),
      (chartTimelineAdvancedChart = new ApexCharts(
        document.querySelector("#advanced_timeline"),
        e
      )).render());
  (t = getChartColorsArray("multi_series_group")) &&
    ((e = {
      series: [
        {
    ...
    "" != chartMultiSeriesGroupChart && chartMultiSeriesGroupChart.destroy(),
    (chartMultiSeriesGroupChart = new ApexCharts(
