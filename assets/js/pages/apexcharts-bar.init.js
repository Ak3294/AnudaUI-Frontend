...
var chartBarChart = "",
  ...
  chartGroupbar = "";
function loadCharts() {
  (t = getChartColorsArray("bar_chart")) &&
    ((e = {
    ...
    (t = getChartColorsArray("custom_datalabels_bar")) &&
      ((e = {
        series: [
      ...
      "" != chartDatalabelsBarChart && chartDatalabelsBarChart.destroy(),
      (chartDatalabelsBarChart = new ApexCharts(
        document.querySelector("#custom_datalabels_bar"),
        e
      )).render()),
    (t = getChartColorsArray("stacked_bar")) &&
      ((e = {
        series: [
      ...
      "" != chartStackedBarChart && chartStackedBarChart.destroy(),
      (chartStackedBarChart = new ApexCharts(
        document.querySelector("#stacked_bar"),
        e
      )).render()),
    (t = getChartColorsArray("stacked_bar_100")) &&
      ((e = {
        series: [
          { name: "Marine Sprite", data: [44, 55, 41, 37, 22, 43, 21] },
          { name: "Striking Calf", data: [53, 32, 33, 52, 13, 43, 32] },
      ...
      "" != chartStackedBar100Chart && chartStackedBar100Chart.destroy(),
      (chartStackedBar100Chart = new ApexCharts(
        document.querySelector("#stacked_bar_100"),
        e
      )).render()),
    (t = getChartColorsArray("negative_bars")) &&
      ((e = {
        series: [
          {
            name: "Males",
      ...
      "" != chartNegativeBarChart && chartNegativeBarChart.destroy(),
      (chartNegativeBarChart = new ApexCharts(
        document.querySelector("#negative_bars"),
        e
      )).render()),
    (t = getChartColorsArray("bar_markers")) &&
      ((e = {
        series: [
          {
            name: "Actual",
        ...
        legend: {
          ...
          markers: { fillColors: t },
        },
      }),
      "" != chartBarMarkersChart && chartBarMarkersChart.destroy(),
      (chartBarMarkersChart = new ApexCharts(
        document.querySelector("#bar_markers"),
        e
      )).render()),
    (t = getChartColorsArray("reversed_bars")) &&
      ((e = {
      ...
      "" != chartBarReversedChart && chartBarReversedChart.destroy(),
      (chartBarReversedChart = new ApexCharts(
        document.querySelector("#reversed_bars"),
        e
      )).render()),
    (t = getChartColorsArray("patterned_bars")) &&
      ((e = {
        series: [
          { name: "Marine Sprite", data: [44, 55, 41, 37, 22, 43, 21] },
          { name: "Striking Calf", data: [53, 32, 33, 52, 13, 43, 32] },
      ...
      "" != chartPatternedChart && chartPatternedChart.destroy(),
      (chartPatternedChart = new ApexCharts(
        document.querySelector("#patterned_bars"),
        e
      )).render());
  (t = getChartColorsArray("grouped_bar")) &&
    ((e = {
      series: [
    ...
    "" != chartGroupbar && chartGroupbar.destroy(),
    (chartGroupbar = new ApexCharts(
  ...
  document.querySelector("#bar_images") &&
    new ApexCharts(document.querySelector("#bar_images"), e).render();
}
