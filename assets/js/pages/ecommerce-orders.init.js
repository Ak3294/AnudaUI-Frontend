...
function isStatus(e) {
  switch (e) {
    case "New":
      return (
        '<span class="badge bg-primary-subtle text-primary">' + e + "</span>"
      );
    case "Pending":
      return (
        '<span class="badge bg-warning-subtle text-warning">' + e + "</span>"
      );
  ...
  Array.from(e).forEach(function (e) {
    orderList.add({
      ...
      shop:
        ...
        e.shop[0].img +
        '" alt="" class="avatar-xxs rounded-circle me-1 shop-logo"> <span class="shop-name">' +
        e.shop[0].name +
        "</span></a>",
    ...
    orderList.remove(
      "order_id",
      '<a href="apps-ecommerce-order-overview.html" class="fw-medium link-primary">#TBS250001</a>'
    ),
    refreshCallbacks(),
    ischeckboxcheck();
}),
  ...
  removeBtns &&
    Array.from(removeBtns).forEach(function (e) {
      e.addEventListener("click", function (e) {
        ...
        e = orderList.get({ order_id: itemId });
        Array.from(e).forEach(function (e) {
          ...
          Array.from(e).forEach(function (e) {
            ...
            a == itemId &&
              ...
              (deliverStatsField.value =
                a.body.querySelector(".badge").innerHTML),
              ...
              (shopNameField.value =
                t.body.querySelector(".shop-name").innerHTML),
              ...
              (document.getElementById("delivery-status-field").value =
                e._values.delivery_date),
              (t = new DOMParser().parseFromString(
                e._values.rating,
                "text/html"
              )),
              (document.getElementById("rating-field").value =
                t.body.querySelector("h5").innerHTML));
          });
        });
      });
}
    ...
    ? Swal.fire({
        ...
        if (e.value) {
          for (i = 0; i < ids_array.length; i++)
            orderList.remove(
              "order_id",
              `<a href="apps-ecommerce-order-overview.html" class="fw-medium link-primary">${ids_array[i]}</a>`
            );
          document.getElementById("remove-actions").classList.add("d-none"),
  ...
  e.addEventListener("submit", function (e) {
    ...
    return (
      ...
      "" == customerNameField.value
        ...
        : "" == productsField.value
        ? !(t.innerHTML = "Please select a products category")
        : "" == orderDateField.value
        ? !(t.innerHTML = "Please select a order date")
        : "" == shopNameField.value
        ? !(t.innerHTML = "Please enter a shop name")
        : "" == amountField.value
        ? !(t.innerHTML = "Please enter a amount")
        : "" == paymentField.value
        ? !(t.innerHTML = "Please select a payment method")
        : "" == deliverStatsField.value
        ? !(t.innerHTML = "Please select a delivery status")
        : ("" === customerNameField.value ||
          "" === productsField.value ||
          "" === orderDateField.value ||
          "" === shopNameField.value ||
          ...
          editList
            ? "" !== customerNameField.value &&
              ...
              "" !== deliverStatsField.value &&
              editList &&
              ((e = orderList.get({ order_id: idField.value })),
              Array.from(e).forEach(function (e) {
                (isid = new DOMParser().parseFromString(
                  ...
                  e.values({
                    order_id:
                      '<a href="apps-ecommerce-order-overview.html" class="fw-medium link-primary">' +
                      idField.value +
                      "</a>",
                    order_date: orderDateField.value,
                    delivery_date: document.getElementById(
            ...
            : (orderList.add({
                order_id:
                  '<a href="apps-ecommerce-order-overview.html" class="fw-medium link-primary">#TBS2500' +
                  count +
                  "</a>",
                order_date: orderDateField.value,
                delivery_date: "--",
                ...
                payment_method: paymentField.value,
                amount:
                  '<span class="fw-medium">' + amountField.value + "</span>",
