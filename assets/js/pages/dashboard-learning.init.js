...
function loadCharts() {
  ...
  (e = getChartColorsArray("total_students")) &&
    ((t = {
      series: [{ name: "Total Students", data: [33, 56, 37, 51, 42, 83, 71] }],
    ...
    (e = getChartColorsArray("total_courses")) &&
      ((t = {
        series: [{ name: "Total Courses", data: [33, 56, 37, 51, 42, 83, 71] }],
  ...
  (e = getChartColorsArray("area_chart_spline")) &&
    ((t = {
      series: [
        ...
        { name: "Last Month", data: [57, 66, 74, 63, 55, 70, 84, 97, 112, 99] },
      ],
...
sorttableDropdown &&
  sorttableDropdown.forEach(function (a) {
    a.querySelectorAll(".dropdown-menu .dropdown-item").forEach(function (e) {
