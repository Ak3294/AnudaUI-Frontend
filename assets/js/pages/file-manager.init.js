        ...
        series: [
          {
            ...
            emphasis: { label: { show: !0, fontSize: 15, fontWeight: "bold" } },
  ...
  bodyElement =
    (sorttableDropdown &&
      sorttableDropdown.forEach(function (o) {
        o.querySelectorAll(".dropdown-menu .dropdown-item").forEach(function (
          t
        ) {
  ...
  isShowMenu =
    (Array.from(document.querySelectorAll("#file-list tr")).forEach(function (
      ...
      e.querySelector(".view-item-btn").addEventListener("click", function () {
        bodyElement.classList.add("file-detail-show"), pieChart.resize();
      });
    }),
