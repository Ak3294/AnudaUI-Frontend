...
function loadCharts() {
  (t = getChartColorsArray("column_chart")) &&
    ((e = {
    ...
    (t = getChartColorsArray("column_chart_datalabel")) &&
      ((e = {
        chart: { height: 350, type: "bar", toolbar: { show: !1 } },
    ...
    (t = getChartColorsArray("column_stacked")) &&
      ((e = {
        series: [
    ...
    (t = getChartColorsArray("column_stacked_chart")) &&
      ((e = {
        series: [
      ...
      "" != chartColumnStacked100Chart && chartColumnStacked100Chart.destroy(),
      (chartColumnStacked100Chart = new ApexCharts(
        document.querySelector("#column_stacked_chart"),
        e
      )).render()),
    (t = getChartColorsArray("column_markers")) &&
      ((e = {
        series: [
          {
            name: "Actual",
    ...
    (t = getChartColorsArray("column_rotated_labels")) &&
      ((e = {
        series: [
          {
            name: "Servings",
    ...
    (t = getChartColorsArray("column_nagetive_values")) &&
      ((e = {
        series: [
          {
            name: "Cash Flow",
        ...
        plotOptions: {
          bar: {
            colors: {
              ranges: [
                { from: -100, to: -46, color: t[1] },
                { from: -45, to: 0, color: t[2] },
              ],
            },
            columnWidth: "80%",
          },
      ...
      "" != chartNagetiveValuesChart && chartNagetiveValuesChart.destroy(),
      (chartNagetiveValuesChart = new ApexCharts(
        document.querySelector("#column_nagetive_values"),
        e
      )).render());
  (t = getChartColorsArray("column_range")) &&
    ((e = {
      series: [
        {
          data: [
  ...
  function s(t, e) {
    ...
    if (t.w.globals.selectedDataPoints[0]) {
      for (
        var o = t.w.globals.selectedDataPoints, s = 0;
        s < o[0].length;
        s++
      ) {
        var l = o[0][s],
      ...
      series: [
        {
          data: [
            ...
            { x: "2012", y: a[1].y, color: t[1], quarters: a[1].quarters },
            { x: "2013", y: a[2].y, color: t[2], quarters: a[2].quarters },
            { x: "2014", y: a[3].y, color: t[3], quarters: a[3].quarters },
            { x: "2015", y: a[4].y, color: t[4], quarters: a[4].quarters },
            { x: "2016", y: a[5].y, color: t[5], quarters: a[5].quarters },
          ],
        },
      ],
      chart: {
  ...
  a.render(),
    ...
    a.addEventListener("dataPointSelection", function (t, e, a) {
      var r = document.querySelector("#chart-quarter"),
        o = document.querySelector("#chart-year");
      1 !== a.selectedDataPoints[0].length ||
        r.classList.contains("active") ||
        (o.classList.add("chart-quarter-activated"), r.classList.add("active")),
        s(e, "barQuarter"),
        0 === a.selectedDataPoints[0].length &&
          (o.classList.remove("chart-quarter-activated"),
          r.classList.remove("active"));
    ...
    (t = getChartColorsArray("column_distributed")) &&
      ((e = {
  ...
  (a = getChartColorsArray("column_group_labels")) &&
    ...
    "" != chartColumnGroupLabelsChart && chartColumnGroupLabelsChart.destroy(),
