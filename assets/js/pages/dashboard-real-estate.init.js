...
function loadCharts() {
  (t = getChartColorsArray("property_sale")) &&
        ...
        series: [
          {
            name: "Income",
            data: [
              32, 18, 13, 17, 26, 34, 47, 51, 59, 63, 44, 38, 53, 69, 72, 83,
              90, 110, 130, 117, 103, 92, 95, 119, 80, 96, 116, 125,
            ],
          },
        ],
    ...
    (t = getChartColorsArray("property_sale_chart")) &&
      ((e = {
        series: [
          {
            name: "Property Rent",
            data: [
              30, 57, 25, 33, 20, 27, 38, 49, 42, 58, 33, 46, 40, 34, 41, 53,
              19, 23, 36, 52, 58, 43,
            ],
          },
        ],
        ...
        colors: t,
        plotOptions: {
          bar: { columnWidth: "30%", distributed: !0, borderRadius: 5 },
        },
  ...
  (t = getChartColorsArray("multiple_radialbar")) &&
    ...
    "" != chartRadialbarMultipleChart && chartRadialbarMultipleChart.destroy(),
