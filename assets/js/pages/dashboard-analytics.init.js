    ...
    (r = getChartColorsArray("pageviews_overview")) &&
      ((a = {
        series: [
          {
            name: "Website",
            data: [
              12, 14.65, 28.24, 25.02, 19.65, 23, 21.18, 23.65, 20.32, 18,
              12.65, 28.32,
            ],
          },
          {
            name: "Social Media",
            data: [
              26, 24.65, 18.24, 29.02, 23.65, 27, 21.18, 24.65, 27.32, 25,
              24.65, 29.32,
            ],
          },
          {
            name: "Others",
            data: [
              -10, -17.32, -15.45, -12.3, -19.15, -15.45, -11, -14.32, -15.67,
              -10, -17.32, -19.2,
            ],
          },
        ],
        chart: { type: "bar", height: 373, stacked: !0, toolbar: { show: !1 } },
        ...
        responsive: [
          {
            breakpoint: 992,
            options: { plotOptions: { bar: { columnWidth: "50px" } } },
          },
          {
            breakpoint: 600,
            options: { plotOptions: { bar: { columnWidth: "70px" } } },
          },
        ],
      }),
    ...
    (r = getChartColorsArray("column_distributed")) &&
      ((a = {
        series: [
          {
            data: [
              30, 57, 25, 33, 20, 39, 47, 36, 22, 51, 38, 27, 38, 49, 42, 58,
              33, 46, 40, 34, 41, 53, 19, 23, 36, 52, 58, 43,
            ],
          },
        ],
