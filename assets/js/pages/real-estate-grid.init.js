...
function paginationEvents() {
  ...
  prevButton.addEventListener("click", function () {
    ...
    nextButton.addEventListener("click", function () {
      currentPage < e() && loadPropertyList(propertyListData, ++currentPage);
    });
        ...
        (propertyListData = propertyListData.map(function (e) {
          ...
          return (
            e.id == r &&
              ...
              dropzone.options.thumbnail.call(dropzone, t, e.property[0].img),
      ...
      (n = t.getAttribute("data-remove-id")),
        document
          ...
          .addEventListener("click", function () {
            ...
            (t = n),
              loadPropertyList(
                (propertyListData = propertyListData.filter(function (e) {
                  return e.id != t;
                })),
                currentPage
              ),
