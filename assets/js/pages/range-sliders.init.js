for (
  var sliderColorScheme = document.querySelectorAll("[data-rangeslider]"),
    multielementslider =
      (sliderColorScheme &&
        Array.from(sliderColorScheme).forEach(function (e) {
          noUiSlider.create(e, {
            start: 127,
            connect: "lower",
            range: { min: 0, max: 255 },
      ...
      document.querySelectorAll("[data-multielement]")),
    resultElement =
      (multielementslider &&
        Array.from(multielementslider).forEach(function (e) {
          noUiSlider.create(e, {
            start: [20, 80],
            connect: !0,
            range: { min: 0, max: 100 },
    ...
    select =
      (sliders &&
        Array.from([].slice.call(sliders)).forEach(function (i, t) {
          noUiSlider.create(i, {
            start: 127,
            connect: [!0, !1],
...
var html5Slider = document.getElementById("html5"),
  ...
  nonLinearSlider =
    (inputNumber &&
      html5Slider &&
      (html5Slider.noUiSlider.on("update", function (e, i) {
        e = e[i];
  ...
  lockedState =
    (nonLinearSlider.noUiSlider.on("update", function (e, i, t, n, l) {
...
function crossUpdate(e, i) {
  var t;
  lockedState &&
    ((e -= lockedValues[(t = slider1 === i ? 0 : 1) ? 0 : 1] - lockedValues[t]),
    i.noUiSlider.set(e));
}
...
lockButton &&
  ...
  slider1 &&
    slider2 &&
    (slider1.noUiSlider.on("update", function (e, i) {
    ...
    slider1.noUiSlider.on("slide", function (e, i) {
...
pips &&
  Array.from(pips).forEach(function (e) {
...
var slider = document.getElementById("slider-color"),
  ...
  i = 0,
  toggleSlider =
    (Array.from(connect).forEach(function (e) {
...
softSlider &&
  ...
  softSlider.noUiSlider.on("change", function (e, i) {
    e[i] < 20
      ...
      : 80 < e[i] && softSlider.noUiSlider.set(80);
  }));
