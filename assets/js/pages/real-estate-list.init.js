...
var perPage = 10,
  ...
  propertyList = new List("propertyList", options).on("updated", function (e) {
    ...
    document.querySelector(".pagination-prev.disabled") &&
      ...
      r && document.querySelector(".pagination-next").classList.add("disabled"),
  ...
  removeBtns &&
    Array.from(removeBtns).forEach(function (e) {
      e.addEventListener("click", function (e) {
        ...
        Array.from(e).forEach(function (e) {
          var e = new DOMParser().parseFromString(e._values.id, "text/html"),
    ...
    editBtns &&
      Array.from(editBtns).forEach(function (e) {
        e.addEventListener("click", function (e) {
          ...
          Array.from(e).forEach(function (e) {
            var t,
              r = new DOMParser().parseFromString(e._values.id, "text/html")
            ...
            r == itemId &&
              ...
              (document.getElementById("property-preview").innerHTML = ""),
              (e = {
                name: r.body.querySelector("img").getAttribute("alt"),
                size: 12345,
              }),
              ...
              Array.from(e).forEach(function (e) {
                new DOMParser().parseFromString(e._values.id, "text/html").body
                  ...
                  e.values({
                    ...
                    propert_Name: `<img src="${t.src}" alt="${t.getAttribute(
                      "alt"
                    )}" class="rounded avatar-sm object-fit-cover d-none"><a href="apps-real-estate-property-overview.html" class="text-reset">${
                      propertyTitleInput.value
                    }</a>`,
