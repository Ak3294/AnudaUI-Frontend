    ...
    return (
      ...
      !editList
        ...
        : "" !== reviewTitleInput.value &&
          ...
          (document.getElementById(n).querySelector(".rate-num").innerHTML =
            parseFloat(e).toFixed(1)),
          (document.getElementById(n).querySelector(".review-title").innerHTML =
            reviewTitleInput.value),
          (document.getElementById(n).querySelector(".review-desc").innerHTML =
            reviewDescInput.value),
          document.getElementById("review-close").click()),
      !0
    );
        ...
        function (e) {
          ...
          (document.getElementById("id-field").value = t),
            ...
            r.querySelectorAll(".product-img") &&
              r.querySelectorAll(".product-img").forEach(function (e) {
