!(function () {
  ...
  if (sessionStorage.getItem("defaultAttribute")) {
    for (
      var t = document.documentElement.attributes, e = {}, a = 0;
      a < t.length;
      a++
    ) {
      var s = t[a];
    ...
    if (JSON.stringify(e) !== sessionStorage.getItem("defaultAttribute"))
      ...
      var o,
        d = {
          ...
          "data-layout-direction": sessionStorage.getItem(
            "data-layout-direction"
          ),
          "data-layout-position": sessionStorage.getItem(
